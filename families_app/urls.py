...
urlpatterns = [
    ...
    path('family/<int:id>/children_progress', views.children_progress, name='children_progress'),
    path('family/<int:id>/download_day', views.download_day_summary, name='download_day_summary'),
